...
//    List<Product> findByOnSaleProducts();
    ...
    @Query("select new com.sto.sale.backstosale.dto.ProductDto(p.goods_id, p.goods_nm, p.stat, p.total_amt, p.total_cnt, p.ordr_fee, p.trade_fee, p.created_dt, p.created_by, s.sale_cnt, s.sale_rate)"
